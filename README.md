...
|Задачи, выполненные на курсе Симулятор аналитика  (__[github](https://github.com/pettekaterina/analyst_simulator)__)|Проведение А/В тестов. Прогнозирование метрик. Построение ETL-пайплайна. Автоматизация отчетности, написание системы алертов |pandas,plotly,scipy,airflow,telegram,sql|
